class Calculator {
    ...
    convert(select1, select2) {
        ...
        if(selected == 0) {
            if(un1 == "tons") {
                converted.tons = valNum
				converted.imperial_tons = valNum / 1.016
				converted.us_tons = valNum * 1.102
				converted.pounds = valNum * 2205
				converted.ounces = valNum * 35274
				converted.kilograms = valNum * 1000
				converted.grams = valNum * 1000000
                this.unit2 = converted[un2]
            }   
            else if(un1 == "imperial_tons") {
                converted.tons = valNum * 1.106
				converted.imperial_tons = valNum
				converted.us_tons = valNum * 1.12
				converted.pounds = valNum * 2240
				converted.ounces = valNum * 35840
				converted.kilograms = valNum * 1016
				converted.grams = valNum * 1016000
                this.unit2 = converted[un2]
            }
            else if(un1 == "us_tons") {
                converted.tons = valNum / 1.102
				converted.imperial_tons = valNum / 1.12
				converted.us_tons = valNum
				converted.pounds = valNum * 2000
				converted.ounces = valNum * 32000
				converted.kilograms = valNum * 907.2
				converted.grams = valNum * 907200
                this.unit2 = converted[un2]
            }
            else if (un1 == "pounds") {
                converted.tons = valNum / 2205
				converted.imperial_tons = valNum / 2240
				converted.us_tons = valNum / 2000
				converted.pounds = valNum
				converted.ounces = valNum * 16
				converted.kilograms = valNum / 2.205
				converted.grams = valNum * 453.6
                this.unit2 = converted[un2]
            }
            else if (un1 == "ounces") {
                converted.tons = valNum / 35270
				converted.imperial_tons = valNum / 35840
				converted.us_tons = valNum / 32000
				converted.pounds = valNum / 16
				converted.ounces = valNum
				converted.kilograms = valNum / 35.274
				converted.grams = valNum * 28.35
                this.unit2 = converted[un2]
            }
            else if (un1 == "kilograms") {
                converted.tons = valNum / 1000
				converted.imperial_tons = valNum / 1016
				converted.us_tons = valNum / 907.2
				converted.pounds = valNum * 2.205
				converted.ounces = valNum * 25.274
				converted.kilograms = valNum
				converted.grams = valNum * 1000
                this.unit2 = converted[un2]
            }
            else if (un1 == "grams") {
                converted.tons = valNum / 1000000
				converted.imperial_tons = valNum / 1016000
				converted.us_tons = valNum / 907200
				converted.pounds = valNum / 453.6
				converted.ounces = valNum / 28.35
				converted.kilograms = valNum / 1000
				converted.grams = valNum
                this.unit2 = converted[un2]
            }
        }
        else if (selected == 1) {
